...
const KanbanBoard = () => {
  ...
  const handleOpenModal = (taskId: string, columnId: string) => {
    setModalState({ isOpen: true, taskId, columnId });
  };

  const handleCloseModal = () => {
    setModalState({ isOpen: false, taskId: '', columnId: '' });
  };
                  ...
                  {(provided) => (
                    ...
                    >
                      <div {...provided.dragHandleProps}>
                        <Column column={state.columns[columnId]} onTaskClick={handleOpenModal} />
                      </div>
                    </div>
                  )}
                </Draggable>
